export const DrinksAlcoholicals = [
    ...
    ingredients: [
      ...
      },
      {
        ...
        ingredient: {
          name: "Lillet blanc",
          description:
            "Lillet is a French wine-based aperitif from Podensac. Classed as an aromatised wine Lillet Blanc a sweeter variant of the white-wine-based version with reduced quinine content.",
          id: "lilletblanc",
        },
      },
      {
        ...
        ingredient: {
          ...
          description:
            "Crème de Cacao is a sweet alcoholic liqueur (chocolate bean) flavored liqueur, often scented with a hint of vanilla. It is different from chocolate liqueur, which is usually sweeter and more syrupy. It comes in 2 varieties, dark and white.",
    ...
    steps: [
      {
        step: 1,
        instructions:
          "Add the gin, Lillet blanc, white creme de cacao and lemon juice to a shaker with ice and shake until well-chilled.",
      },
      {
        step: 2,
    ...
    glasses: [
      ...
      },
      {
        ...
        glass: {
          ...
          description:
            "The familiar conical shape of the cocktail glass makes most people think of a martini. Cocktail glasses are used for drinks between 3 and 6 ounces. Cocktail glasses are also a good alternative to margarita glasses.",
  ...
  },
  {
    ...
    description:
      "The martini is a cocktail made with gin and vermouth, and garnished with an olive or a lemon twist. A 50/50 martini uses equal amounts of gin and vermouth.",
    additional_tips: "",
    alcoholic: true,
    garnish: "lemon twist",
    ingredients: [
      ...
      },
      {
        ...
        ingredient: {
          name: "dry vermouth",
          description:
            "Vermouth is an aromatized fortified wine, sweet vermouth has a higher amount of sugar added and is often brownish red from caramel coloring.",
          id: "dryvermouth",
        },
      },
      {
    ...
    steps: [
      {
        step: 1,
        instructions:
          "In a mixing glass add the gin, dry vermouth and orange bitters. Fill with ice and stir until well-chilled.",
      },
      {
        step: 2,
  ...
  },
  {
    ...
    description:
      "A 7 and 7 is a highball cocktail, a mixed alcoholic drink containing Seagram's Seven Crown and 7 Up. It is typically served with ice. It was one of the most popular drinks in the United States during the 1970s.",
    additional_tips: "",
    alcoholic: true,
    garnish: "",
    ingredients: [
      {
        ...
        ingredient: {
          ...
          description:
            "Seagram’s 7 Crown is blended American whiskey aged in oak.",
          id: "seagrams7",
        },
      },
      {
        ...
        ingredient: {
          name: "7UP",
          description:
            "7 Up (stylized as 7up outside North America) is an American brand of lemon-lime-flavored non-caffeinated soft drink. The brand and formula is owned by Keurig Dr Pepper although the beverage is internationally distributed by PepsiCo. 7 Up competes primarily against The Coca-Cola Company's Sprite.",
          id: "7up",
        },
      },
    ],
    ...
    glasses: [
      {
        ...
        glass: {
          name: "Highball Glass",
          description:
            "They can be used for tall drinks ,though that can be anywhere from 8 to 16 ounces. The collins glass tends to be taller and narrower, more of a chimney shape.",
      ...
      },
      {
        ...
        glass: {
          name: "Collins Glass",
          description:
            "Tall glasses are essential in any bar. They're used for tall mixed drinks. The highball is typically more stout and tops off at 10 ounces.",
  ...
  },
  {
    ...
    description:
      "Adios Motherfucker or AMF (also known as Boston tea party) is considered a variation of the Long Island Iced Tea with Blue Curaçao substituting for the triple sec, and with lemon-lime soda substituting for the cola.",
    additional_tips: "",
    alcoholic: true,
    ...
    ingredients: [
      ...
      },
      {
        ...
        ingredient: {
          name: "blue curaçao",
          description:
            "Curaçao is a liqueur flavored with the dried peel of the bitter orange laraha, a citrus fruit grown on the Dutch island of Curaçao. Curaçao can be sold in numerous forms, though the most common are the orange-hued dry Curaçao and blue Curaçao, which is dyed bright blue.",
          id: "bluecuracao",
        },
      },
      {
      ...
      },
      {
        ...
        ingredient: {
          name: "simple syrup",
          description:
            "Inverted sugar syrup, also known as simple syrup, is a basic sugar-and-water syrup. It is used by bartenders as a sweetener to make cocktails. The ratio of sugar to water is 1:1 by volume for normal simple syrup.",
          id: "simplesyrup",
        },
      },
      {
    ...
    steps: [
      {
        step: 1,
        instructions:
          "Add vodka, rum, gin, tequila, blue curaçao, lemon juice and simple syrup into a cocktail shaker with ice and shake until well-chilled.",
      },
      {
        step: 2,
      ...
      },
      {
        step: 3,
        instructions:
          "Top with lemon-lime soda and garnish with a lemon wheel.",
      },
    ],
    glasses: [
      {
    ...
    ingredients: [
      {
        ...
        ingredient: {
          name: "fino sherry",
          description:
            "Sherry is a fortified wine made from white grapes that are grown near the city of Jerez de la Frontera in Andalusia, Spain. Fino is the traditional dry sherry, typically bottled around 3 to 5 years.",
          id: "finosherry",
        },
      },
      {
        ...
        ingredient: {
          name: "sweet vermouth",
          description:
            "Vermouth is an aromatized fortified wine, dry vermouth are lighter in body known for being used in the Martini. It has little to no sugar added and will taste more herbaceous but less bitter.",
          id: "sweetvermouth",
        },
      },
    ],
    steps: [
      {
        step: 1,
        instructions:
          "In a mixing glass filled with ice, add the fino sherry and the sweet vermouth and stir until well-chilled.",
      },
      {
        step: 2,
        instructions: "Strain into a chilled coupe glass.",
      },
      {
        step: 3,
        instructions: "Garnish with an orange peel.",
      },
    ],
    glasses: [
      {
  ...
  },
  {
    ...
    ingredients: [
      {
        ...
        ingredient: {
          ...
          description:
            "Southern Comfort (often abbreviated SoCo) is an American, naturally fruit-flavored, whiskey liqueur with fruit and spice accents. The brand was created by bartender Martin Wilkes Heron in New Orleans in 1874, using whiskey as the base spirit.",
          id: "southerncomfort",
        },
      },
      {
        ...
        ingredient: {
          name: "Sloe gin",
          description:
            "Sloe gin is a British red liqueur made with gin and sloes. Sloes are the fruit (drupe) of Prunus spinosa, the blackthorn plant, a relative of the plum.",
          id: "sloegin",
        },
      },
      {
        ...
        ingredient: {
          name: "amaretto",
          description:
            'Amaretto (Italian for a little bitter") is a sweet Italian liqueur that originated in Saronno. Depending on the brand',
          id: "amaretto",
        },
      },
      {
        ...
        ingredient: {
          name: "orange juice",
          description:
            "Orange juice is a liquid extract of the orange fruit, produced by squeezing or reaming oranges.",
          id: "orangejuice",
        },
      },
    ],
    steps: [
      ...
      {
        step: 3,
        instructions: "Garnish with an orange wedge.",
      },
    ],
    glasses: [
      {
  ...
  },
  {
    ...
    description:
      'Made with Campari, sweet vermouth, and for the sparkling version, club soda and garnished with a slice of lemon. The cocktail was first served in creator Gaspare Campari\'s bar, Caffè Campari in Milan, in the 1860s. It is the direct descendant of the "Milano-Torino" which consisted of Campari, the bitter liqueur from Milan (Milano) and Punt e Mes, the vermouth from Turin (Torino) but lacked soda water.',
    additional_tips: "",
    alcoholic: true,
    garnish: "orange twist",
    ingredients: [
      {
        ...
        ingredient: {
          name: "Campari",
          description:
            "Campari is an Italian alcoholic liqueur, considered an apéritif, obtained from the infusion of herbs and fruit in alcohol and water. It is a type of bitters, characterised by its dark red colour.",
          id: "campari",
        },
      },
      {
    ...
    steps: [
      ...
      {
        step: 2,
        instructions: "Top with the soda water and stir gently to combine.",
      },
      {
        step: 3,
    ...
    glasses: [
      ...
      },
      {
        list_order: 3,
        glass: {
          name: "Old-Fashioned (or Rocks) Glass",
          description:
            'The old-fashioned glass is a short tumbler with a thick bottom. It\'s also called a "lowball" or "rocks" glass. Typically used for short mixed drinks-including the famous old-fashioned that are served on the rocks. Old-fashioned glasses hold between 6 and 8 ounces.',
          image_url: "https://rapid.drinks.digital/static/rocks.png",
          id: "rocks",
        },
      },
    ],
    tags: [
      ...
      },
      {
        ...
        tag: {
          id: "iba",
          name: "International Bartenders Association Official Cocktails",
        },
      },
    ],
  },
  {
    ...
    description:
      'The Ancient Mariner is a tiki drink created by Jeff "Beachbum" Berry and Annene Kaye. It first appeared in their 1998 drink guide Beachbum Berry\'s Grog Log and is named after Coleridge\'s 1798 The Rime of the Ancient Mariner because in Berry\'s words “by the time we finished with it, that’s how old we felt. Its signature ingredient is pimento flavored liqueur, which in the United States is most commonly referred to as "pimento dram" or "allspice dram" due to conflation of pimento and pimenta.',
    additional_tips: "",
    alcoholic: true,
    ...
    ingredients: [
      {
        ...
        ingredient: {
          ...
          description:
            "Deep Amber rum distilled from fermented molasses. Aged up to five years. This blend of aged Demerara rums is bottled at 151 proof to bring the full flavor to tiki and other cocktails that call for Demerara Overproof rum. Rich flavors of dark, stone fruit, smoky wood, burnt cane, treacle and brown spice.",
          id: "151proofrum",
        },
      },
      {
        ...
        ingredient: {
          name: "dark rum",
          description:
            "Dark rums, also known by their particular colour, such as brown, black, or red rums, are classes a grade darker than gold rums. They are usually made from caramelized sugar or molasses. They are generally aged longer, in heavily charred barrels.",
          id: "darkrum",
        },
      },
      {
        list_order: 3,
        amount: "1/4 ounce (7.5ml)",
        ingredient: {
          name: "pimento dram",
          description:
            'Pimento flavored liqueur, which in the United States is most commonly referred to as "pimento dram" or "allspice dram" due to conflation of pimento and pimenta.',
          id: "pimentodram",
        },
      },
      {
    ...
    steps: [
      ...
      {
        step: 3,
        instructions: "Garnish with a lime wedge and a mint sprig.",
      },
    ],
    glasses: [
      {
    ...
    ingredients: [
      ...
      },
      {
        ...
        ingredient: {
          ...
          description:
            "Obtained from the infusion of apricots' pulp in sugar beet alcohol, Luxardo Apricot is very rich in taste with mild cinnamon spice and light almond finish.",
          id: "luxardoapricot",
        },
      },
    ],
    steps: [
      {
        step: 1,
        instructions:
          "Pour the gin, applejack and apricot liqueur into a mixing glass with ice and stir until well-chilled.",
      },
      {
        step: 2,
        instructions: "Strain into a cocktail glass.",
      },
      {
        step: 3,
        instructions: "Garnish with an orange twist.",
  ...
  },
  {
    ...
    description:
      "The Aperol sunrise is a variant of tequila sunrise which substitutes Aperol orange liqueur for grenadine.",
    additional_tips: "",
    alcoholic: true,
    garnish: "orange wedge",
    ingredients: [
      {
        list_order: 1,
        amount: "2 ounces (60ml)",
        ingredient: {
          name: "blanco tequila",
          description:
            "Tequila is a distilled beverage made from the blue agave plant. Silver/Blanco tequila provides the clearest form as little aging has occurred.",
          id: "blancotequila",
        },
      },
      {
      ...
      },
      {
        ...
        ingredient: {
          name: "Aperol",
          description:
            "Aperol is an Italian bitter apéritif made of gentian, rhubarb and cinchona, among other ingredients. It has a vibrant orange hue. Its name comes from apero, an Italian slang word for apéritif.",
          id: "aperol",
        },
      },
    ],
    steps: [
      {
        step: 1,
        instructions:
          "Add the tequila and then the orange juice to a chilled hurricane glass filled with ice.",
      },
      {
        step: 2,
        instructions: "Top with the Aperol to create a layered effect.",
      },
      {
        step: 3,
        instructions: "Garnish with an orange wedge.",
    ...
    glasses: [
      {
        ...
        glass: {
          ...
          image_url: "https://rapid.drinks.digital/static/hurricane.png",
          id: "hurricane",
        },
      },
      {
  ...
  },
  {
    ...
    steps: [
      ...
      },
      {
        step: 2,
        instructions:
          "Double-strain the mixture into the well-chilled cocktail glass.",
      },
      {
        step: 3,
        instructions:
    ...
    ingredients: [
      ...
      },
      {
        ...
        ingredient: {
          ...
          description:
            "Maraschino is a liqueur obtained from the distillation of Marasca cherries. The small, slightly sour fruit of the Tapiwa cherry tree, which grows wild along parts of the Dalmatian coast in Croatia, lends the liqueur its unique aroma.",
          id: "maraschinoliqueur",
        },
      },
      {
        list_order: 3,
        amount: "1 teaspoon (5ml)",
        ingredient: {
    ...
    steps: [
      {
        step: 1,
        instructions:
          "Pour gin, maraschino liqueur, creme de violette and lemon juice into a cocktail shaker with ice and shake until well-chilled.",
      },
      {
        step: 2,
        instructions: "Strain into a cocktail or coupe glass.",
      },
      {
        step: 3,
        instructions: "Garnish with a brandied cherry.",
      },
    ],
    glasses: [
      {
    ...
    steps: [
      {
        step: 1,
        instructions:
          "Add cognac, Bénédictine and simple syrup into a mixing glass with ice and stir until well-chilled.",
      },
      {
        step: 2,
        instructions: "Strain into a rocks glass over fresh ice.",
      },
    ],
    glasses: [
      {
    ...
    ingredients: [
      {
        ...
        ingredient: {
          name: "gold rum",
          description:
            "Gold rum might also be known as amber rum. It's essentially a little darker than light rum and a little lighter than black rum. It has an amber color and is a little sweeter to taste. The flavor is known as rich and sometimes buttery.",
          id: "goldrum",
        },
      },
      {
      ...
      },
      {
        ...
        ingredient: {
          ...
          description:
            "Pineapple juice is a liquid made from pressing the natural liquid from the pulp of the pineapple.",
          id: "pineapplejuice",
        },
      },
      {
    ...
    steps: [
      {
        step: 1,
        instructions:
          "Add rum, Galliano, pineapple juice and lime juice to a cocktail shaker filled with ice, and shake until well-chilled.",
      },
      {
        step: 2,
        instructions:
          "Strain into a highball glass over fresh ice, and top with Prosecco.",
      },
      {
        step: 3,
        instructions: "Garnish with a pineapple wedge and cherry.",
      },
    ],
    glasses: [
      {
    ...
    ingredients: [
      ...
      },
      {
        ...
        ingredient: {
          ...
          description:
            "Cranberry juice is the liquid juice of the cranberry, typically manufactured to contain sugar, water, and other fruit juices. Cranberry is a fruit native to North America is recognized for its bright red color, tart taste, and versatility for product manufacturing.",
          id: "cranberryjuice",
        },
      },
      {
  ...
  },
  {
    ...
    description:
      "A Bees Knees (or Bee's Knees) is a Prohibition Era cocktail made with gin, fresh lemon juice, and honey. It is served shaken and chilled, often with a lemon twist. The name comes from prohibition-era slang meaning \"the best\". The Bee's Knees was invented by Frank Meier, an Austrian-born, part Jewish bartender who was the first head bartender at the Ritz in Paris in 1921, when its Cafe Parisian opened its doors.",
    additional_tips: "",
    alcoholic: true,
    garnish: "lemon twist",
    ingredients: [
      ...
      },
      {
        ...
        ingredient: {
          name: "honey syrup",
          description:
            "Commonly made in a 1:1 ratio 1 part honey and 1 part water.",
          id: "honeysyrup",
        },
      },
    ],
    ...
    steps: [
      {
        step: 1,
        instructions:
          "Pour peach puree into the mixing glass with ice, add the Prosecco wine and stir gently.",
      },
      {
        step: 2,
        instructions: "Strain into a chilled champagne flute or similar glass.",
      },
      {
        step: 3,
        instructions: "Garnish with a peach slice.",
      },
    ],
    glasses: [
      {
        ...
        glass: {
          ...
          image_url: "https://rapid.drinks.digital/static/flute.png",
          id: "flute",
        },
      },
      {
    ...
    steps: [
      {
        step: 1,
        instructions:
          "Pour cognac, rum, triple sec and lemon juice into a cocktail shaker with ice and shake until well-chilled.",
      },
      {
        step: 2,
        instructions: "Strain into a chilled cocktail glass.",
      },
      {
        step: 3,
        instructions:
          "Express the oils from a orange peel over the top of the drink, then discard the peel before serving.",
      },
    ],
    glasses: [
      {
  ...
  },
  {
    ...
    steps: [
      ...
      {
        step: 2,
        instructions: "Strain into a chilled Nick & Nora or coupe glass.",
      },
      {
        step: 3,
        instructions: "Garnish with a maraschino cherry, if desired.",
      },
    ],
    glasses: [
      {
  ...
  },
  {
    ...
    description:
      "The Black Russian is a cocktail of vodka and coffee liqueur. It contains vodka and coffee liqueur. The drink is made by pouring the vodka and coffee liqueur over ice cubes or cracked ice in an old-fashioned glass and stirring. The Black Russian cocktail first appeared in 1949 and is ascribed to Gustave Tops, a Belgian barman, who created it at the Hotel Metropole in Brussels in honor of Perle Mesta, then United States Ambassador to Luxembourg. The cocktail owes its name to the use of vodka, a typical Russian spirit, and the blackness of the coffee liqueur.",
    additional_tips: "",
    alcoholic: true,
    garnish: "",
    ingredients: [
      ...
      },
      {
        ...
        ingredient: {
          name: "coffee liqueur",
          description:
            "Coffee liqueur is a alcoholic beverage that contains a spirit typically rum with addition of sugar and coffee.",
          id: "coffeeliqueur",
        },
      },
      {
    ...
    steps: [
      {
        step: 1,
        instructions:
          "Add vodka and coffee liqueur into a mixing glass with ice and stir until well-chilled.",
      },
      {
        step: 2,
        instructions: "Strain into a rocks glass over fresh ice.",
